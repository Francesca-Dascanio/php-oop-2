...
$dryFood = new Food ('Dry Food for fatties', 2, 12.99, 'https://assets.petco.com/petco/image/upload/f_auto,q_auto/2161211-center-1', 'Food', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque pellentesque varius tellus, ac consectetur orci.', $cat, '12/03/2024');

$catToy = new Toy ('Wild Mouse with LED Eyes', 3, 6.59, 'https://m.media-amazon.com/images/I/51-EG8QtZLL.jpg', 'Toys', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque pellentesque varius tellus, ac consectetur orci.', $cat, 'pl');
